...
1. **Read** `AGENT.md` for project coding standards
...
### Universal Checklist
- [ ] Code follows project conventions (check AGENT.md)
...
- **Reference standards**: Point to AGENT.md for conventions
...
### For Reviews
1. Start with project standards (AGENT.md)
